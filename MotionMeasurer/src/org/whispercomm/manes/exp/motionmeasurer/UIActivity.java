...
public class UIActivity extends Activity {
	...
	public static final String TAG = "org.whispercomm.manes.exp.motionmeasurer.UIActivity";
	/**
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.sensor = new MotionSensor(this, uiHandler);
	}
	...
	private void initializeGUI() {
		...
		hint.append("Please enter motion update rate (0, 1, 2, 3):");
		ll.addView(hint);
			...
			public void onClick(View v) {
				...
				if (scanPeriod >= 0) {
					...
					Toast toast = Toast.makeText(getApplicationContext(),
							"Start motion update in rate " + scanPeriodString
									+ " !", Toast.LENGTH_LONG);
					toast.show();
				} else {
