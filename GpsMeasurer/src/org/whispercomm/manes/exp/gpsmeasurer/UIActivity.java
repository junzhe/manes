...
public class UIActivity extends Activity {
	...
	public static final String TAG = "org.whispercomm.manes.exp.gpsmeasurer.UIActivity";
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.sensor = new GpsSensor(this, uiHandler);
    }
    ...
    private void initializeGUI() {
		...
		hint.append("Please enter gps update interval in seconds:");
		ll.addView(hint);
            ...
            public void onClick(View v) {
				...
				if (scanPeriod > 0) {
					...
					Toast toast = Toast.makeText(getApplicationContext(),
							"Start gps update every " + scanPeriodString
